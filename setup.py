...
def get_extensions():
    return cythonize([
        Extension(
            "scene_synthesis.libmesh.triangle_hash",
            sources=["scene_synthesis/libmesh/triangle_hash.pyx"],
            include_dirs=[np.get_include()],
            libraries=["m"]  # Unix-like specific
        ),
        Extension(
            "scene_synthesis.libmise.mise",
             sources=["scene_synthesis/libmise/mise.pyx"]
        )
    ])
